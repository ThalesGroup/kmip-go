...
func (c CredentialType) String() string {
	return FormatEnum(uint32(c), &CredentialTypeEnum)
}
...
var KeyCompressionTypeEnum Enum
...
func init() {
	...
	KeyCompressionTypeEnum = NewEnum()
	for v, name := range m {
		KeyCompressionTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (k KeyCompressionType) String() string {
	return FormatEnum(uint32(k), &KeyCompressionTypeEnum)
}
...
func init() {
	...
	KeyFormatTypeEnum = NewEnum()
	for v, name := range m {
		KeyFormatTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (k KeyFormatType) String() string {
	return FormatEnum(uint32(k), &KeyFormatTypeEnum)
}
...
func init() {
	...
	WrappingMethodEnum = NewEnum()
	for v, name := range m {
		WrappingMethodEnum.RegisterValue(uint32(v), name)
	}
}
...
func (w WrappingMethod) String() string {
	return FormatEnum(uint32(w), &WrappingMethodEnum)
}
...
func (r RecommendedCurve) String() string {
	return FormatEnum(uint32(r), &RecommendedCurveEnum)
}
...
func init() {
	...
	CertificateTypeEnum = NewEnum()
	for v, name := range m {
		CertificateTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (c CertificateType) String() string {
	return FormatEnum(uint32(c), &CertificateTypeEnum)
}
...
var DigitalSignatureAlgorithmEnum Enum
...
func init() {
	...
	DigitalSignatureAlgorithmEnum = NewEnum()
	for v, name := range m {
		DigitalSignatureAlgorithmEnum.RegisterValue(uint32(v), name)
	}
}
...
func (d DigitalSignatureAlgorithm) String() string {
	return FormatEnum(uint32(d), &DigitalSignatureAlgorithmEnum)
}
...
func init() {
	...
	SplitKeyMethodEnum = NewEnum()
	for v, name := range m {
		SplitKeyMethodEnum.RegisterValue(uint32(v), name)
	}
}
...
func (s SplitKeyMethod) String() string {
	return FormatEnum(uint32(s), &SplitKeyMethodEnum)
}
...
func init() {
	...
	SecretDataTypeEnum = NewEnum()
	for v, name := range m {
		SecretDataTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (s SecretDataType) String() string {
	return FormatEnum(uint32(s), &SecretDataTypeEnum)
}
...
var OpaqueDataTypeEnum Enum

func init() {
	m := map[OpaqueDataType]string{}

	OpaqueDataTypeEnum = NewEnum()
	for v, name := range m {
		OpaqueDataTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (o OpaqueDataType) String() string {
	return FormatEnum(uint32(o), &OpaqueDataTypeEnum)
}
...
func init() {
	...
	NameTypeEnum = NewEnum()
	for v, name := range m {
		NameTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (n NameType) String() string {
	return FormatEnum(uint32(n), &NameTypeEnum)
}
...
func (o ObjectType) String() string {
	return FormatEnum(uint32(o), &ObjectTypeEnum)
}
...
var CryptographicAlgorithmEnum Enum
...
func init() {
	...
	CryptographicAlgorithmEnum = NewEnum()
	for v, name := range m {
...
func (c CryptographicAlgorithm) String() string {
	return FormatEnum(uint32(c), &CryptographicAlgorithmEnum)
}
...
func init() {
	...
	BlockCipherModeEnum = NewEnum()
	for v, name := range m {
		BlockCipherModeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (b BlockCipherMode) String() string {
	return FormatEnum(uint32(b), &BlockCipherModeEnum)
}
...
func init() {
	...
	PaddingMethodEnum = NewEnum()
	for v, name := range m {
		PaddingMethodEnum.RegisterValue(uint32(v), name)
	}
}
...
func (p PaddingMethod) String() string {
	return FormatEnum(uint32(p), &PaddingMethodEnum)
}
...
func init() {
	...
	HashingAlgorithmEnum = NewEnum()
	for v, name := range m {
		HashingAlgorithmEnum.RegisterValue(uint32(v), name)
	}
}
...
func (h HashingAlgorithm) String() string {
	return FormatEnum(uint32(h), &HashingAlgorithmEnum)
}
...
func init() {
	...
	KeyRoleTypeEnum = NewEnum()
	for v, name := range m {
		KeyRoleTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (k KeyRoleType) String() string {
	return FormatEnum(uint32(k), &KeyRoleTypeEnum)
}
...
func init() {
	...
	StateEnum = NewEnum()
	for v, name := range m {
		StateEnum.RegisterValue(uint32(v), name)
	}
}
...
func (s State) String() string {
	return FormatEnum(uint32(s), &StateEnum)
}
...
var RevocationReasonCodeEnum Enum
...
func init() {
	...
	RevocationReasonCodeEnum = NewEnum()
	for v, name := range m {
		RevocationReasonCodeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (r RevocationReasonCode) String() string {
	return FormatEnum(uint32(r), &RevocationReasonCodeEnum)
}
...
func (l LinkType) String() string {
	return FormatEnum(uint32(l), &LinkTypeEnum)
}
...
func (d DerivationMethod) String() string {
	return FormatEnum(uint32(d), &DerivationMethodEnum)
}
...
var CertificateRequestTypeEnum Enum
...
func init() {
	...
	CertificateRequestTypeEnum = NewEnum()
	for v, name := range m {
		CertificateRequestTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (c CertificateRequestType) String() string {
	return FormatEnum(uint32(c), &CertificateRequestTypeEnum)
}
...
var ValidityIndicatorEnum Enum
...
func init() {
	...
	ValidityIndicatorEnum = NewEnum()
	for v, name := range m {
		ValidityIndicatorEnum.RegisterValue(uint32(v), name)
	}
}
...
func (v ValidityIndicator) String() string {
	return FormatEnum(uint32(v), &ValidityIndicatorEnum)
}
...
func (q QueryFunction) String() string {
	return FormatEnum(uint32(q), &QueryFunctionEnum)
}
...
var CancellationResultEnum Enum
...
func init() {
	...
	CancellationResultEnum = NewEnum()
	for v, name := range m {
		CancellationResultEnum.RegisterValue(uint32(v), name)
	}
}
...
func (c CancellationResult) String() string {
	return FormatEnum(uint32(c), &CancellationResultEnum)
}
...
func init() {
	...
	PutFunctionEnum = NewEnum()
	for v, name := range m {
		PutFunctionEnum.RegisterValue(uint32(v), name)
	}
}
...
func (p PutFunction) String() string {
	return FormatEnum(uint32(p), &PutFunctionEnum)
}
...
func (o Operation) String() string {
	return FormatEnum(uint32(o), &OperationEnum)
}
...
func init() {
	...
	ResultStatusEnum = NewEnum()
	for v, name := range m {
		ResultStatusEnum.RegisterValue(uint32(v), name)
	}
}
...
func (r ResultStatus) String() string {
	return FormatEnum(uint32(r), &ResultStatusEnum)
}
...
func (r ResultReason) String() string {
	return FormatEnum(uint32(r), &ResultReasonEnum)
}
...
var BatchErrorContinuationOptionEnum Enum
...
func init() {
	...
	BatchErrorContinuationOptionEnum = NewEnum()
	for v, name := range m {
		BatchErrorContinuationOptionEnum.RegisterValue(uint32(v), name)
	}
}
...
func (b BatchErrorContinuationOption) String() string {
	return FormatEnum(uint32(b), &BatchErrorContinuationOptionEnum)
}
...
func init() {
	...
	UsageLimitsUnitEnum = NewEnum()
	for v, name := range m {
		UsageLimitsUnitEnum.RegisterValue(uint32(v), name)
	}
}
...
func (u UsageLimitsUnit) String() string {
	return FormatEnum(uint32(u), &UsageLimitsUnitEnum)
}
...
func init() {
	...
	EncodingOptionEnum = NewEnum()
	for v, name := range m {
		EncodingOptionEnum.RegisterValue(uint32(v), name)
	}
}
...
func (e EncodingOption) String() string {
	return FormatEnum(uint32(e), &EncodingOptionEnum)
}
...
var ObjectGroupMemberEnum Enum
...
func init() {
	...
	ObjectGroupMemberEnum = NewEnum()
	for v, name := range m {
		ObjectGroupMemberEnum.RegisterValue(uint32(v), name)
	}
}
...
func (o ObjectGroupMember) String() string {
	return FormatEnum(uint32(o), &ObjectGroupMemberEnum)
}
...
var AlternativeNameTypeEnum Enum
...
func init() {
	...
	AlternativeNameTypeEnum = NewEnum()
	for v, name := range m {
		AlternativeNameTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (a AlternativeNameType) String() string {
	return FormatEnum(uint32(a), &AlternativeNameTypeEnum)
}
...
var KeyValueLocationTypeEnum Enum
...
func init() {
	...
	KeyValueLocationTypeEnum = NewEnum()
	for v, name := range m {
		KeyValueLocationTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (k KeyValueLocationType) String() string {
	return FormatEnum(uint32(k), &KeyValueLocationTypeEnum)
}
...
func init() {
	...
	AttestationTypeEnum = NewEnum()
	for v, name := range m {
		AttestationTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (a AttestationType) String() string {
	return FormatEnum(uint32(a), &AttestationTypeEnum)
}
...
func init() {
	...
	RNGAlgorithmEnum = NewEnum()
	for v, name := range m {
		RNGAlgorithmEnum.RegisterValue(uint32(v), name)
	}
}
...
func (r RNGAlgorithm) String() string {
	return FormatEnum(uint32(r), &RNGAlgorithmEnum)
}
...
func init() {
	...
	DRBGAlgorithmEnum = NewEnum()
	for v, name := range m {
		DRBGAlgorithmEnum.RegisterValue(uint32(v), name)
	}
}
...
func (d DRBGAlgorithm) String() string {
	return FormatEnum(uint32(d), &DRBGAlgorithmEnum)
}
...
func init() {
	...
	FIPS186VariationEnum = NewEnum()
	for v, name := range m {
		FIPS186VariationEnum.RegisterValue(uint32(v), name)
	}
}
...
func (f FIPS186Variation) String() string {
	return FormatEnum(uint32(f), &FIPS186VariationEnum)
}
...
var ValidationAuthorityTypeEnum Enum
...
func init() {
	...
	ValidationAuthorityTypeEnum = NewEnum()
	for v, name := range m {
		ValidationAuthorityTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (v ValidationAuthorityType) String() string {
	return FormatEnum(uint32(v), &ValidationAuthorityTypeEnum)
}
...
func init() {
	...
	ValidationTypeEnum = NewEnum()
	for v, name := range m {
		ValidationTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (v ValidationType) String() string {
	return FormatEnum(uint32(v), &ValidationTypeEnum)
}
...
func (p ProfileName) String() string {
	return FormatEnum(uint32(p), &ProfileNameEnum)
}
...
func init() {
	...
	UnwrapModeEnum = NewEnum()
	for v, name := range m {
		UnwrapModeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (u UnwrapMode) String() string {
	return FormatEnum(uint32(u), &UnwrapModeEnum)
}
...
func init() {
	...
	DestroyActionEnum = NewEnum()
	for v, name := range m {
		DestroyActionEnum.RegisterValue(uint32(v), name)
	}
}
...
func (d DestroyAction) String() string {
	return FormatEnum(uint32(d), &DestroyActionEnum)
}
...
var ShreddingAlgorithmEnum Enum
...
func init() {
	...
	ShreddingAlgorithmEnum = NewEnum()
	for v, name := range m {
		ShreddingAlgorithmEnum.RegisterValue(uint32(v), name)
	}
}
...
func (s ShreddingAlgorithm) String() string {
	return FormatEnum(uint32(s), &ShreddingAlgorithmEnum)
}
...
func init() {
	...
	RNGModeEnum = NewEnum()
	for v, name := range m {
		RNGModeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (r RNGMode) String() string {
	return FormatEnum(uint32(r), &RNGModeEnum)
}
...
var ClientRegistrationMethodEnum Enum
...
func init() {
	...
	ClientRegistrationMethodEnum = NewEnum()
	for v, name := range m {
		ClientRegistrationMethodEnum.RegisterValue(uint32(v), name)
	}
}
...
func (c ClientRegistrationMethod) String() string {
	return FormatEnum(uint32(c), &ClientRegistrationMethodEnum)
}
...
func init() {
	...
	KeyWrapTypeEnum = NewEnum()
	for v, name := range m {
		KeyWrapTypeEnum.RegisterValue(uint32(v), name)
	}
}
...
func (k KeyWrapType) String() string {
	return FormatEnum(uint32(k), &KeyWrapTypeEnum)
}
...
func init() {
	...
	MaskGeneratorEnum = NewEnum()
	for v, name := range m {
		MaskGeneratorEnum.RegisterValue(uint32(v), name)
	}
}
...
func (m MaskGenerator) String() string {
	return FormatEnum(uint32(m), &MaskGeneratorEnum)
}
...
var CryptographicUsageMaskEnum Enum
...
func init() {
	...
	CryptographicUsageMaskEnum = NewBitmask()
	for v, name := range m {
		CryptographicUsageMaskEnum.RegisterValue(uint32(v), name)
	}
}
...
func (c CryptographicUsageMask) String() string {
	return FormatInt(int32(c), &CryptographicUsageMaskEnum)
}
...
var StorageStatusMaskEnum Enum
...
func init() {
	...
	StorageStatusMaskEnum = NewBitmask()
	for v, name := range m {
		StorageStatusMaskEnum.RegisterValue(uint32(v), name)
	}
}
...
func (s StorageStatusMask) String() string {
	return FormatInt(int32(s), &StorageStatusMaskEnum)
}

func RegisterGeneratedDefinitions(r *Registry) {
	...
	for tagName, enum := range enums {
		tag, err := DefaultRegistry.ParseTag(tagName)
		if err != nil {
			panic(err)
		}
		e := enum
