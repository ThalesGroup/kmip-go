...
// to canonical names from the KMIP spec.  It is pre-populated with the 1.4 spec's
...
// canonical form of the name.  Typically, this means removing spaces,
// and replacing some special characters.  The canonical form of the name
...
// to the canonical string names of the value as declared in the KMIP specs.
